...
void UI::demonstration_mode_deque_custom() {
	...
	TimeManagment a;
	cout << "TimeManagment a. a.get_date_with_time(1) = " << a.get_date_with_time(1) << endl;
	Sleep(200);
	cout << "test.empty() = " << test.empty() << endl;
	cout << "test.size() = " << test.size() << endl << endl;
	...
	cout << "TimeManagment b = test.front(), b.get_date_with_time(1) = " << b.get_date_with_time(1) << endl;
	b = test.back();
	cout << "b = test.back(), b.get_date_with_time(1) = " << b.get_date_with_time(1) << endl;
	cout << "test.size() = " << test.size() << endl << endl;
	Sleep(200);
	cout << "Let's pop back. " << endl;
	b = test.pop_back();
	cout << "b = test.pop_back(), b.get_date_with_time(1) = " << b.get_date_with_time(1) << endl;
	Sleep(200);
	cout << "Check empty of deque: test.empty() = " << test.empty() << endl << endl;
	Sleep(200);
...
void UI::demonstration_mode_queue_int() {
	...
	Sleep(200);
	test.push_back(a);
	cout << "Let's push int a: test.push_back(a). " << endl;
	Sleep(200);
	cout << "Check value: " << endl;
	Sleep(200);
	cout << "test.front() = " << test.front() << endl;
	...
	cout << "int b = " << b << endl;
	test.push_back(b);
	cout << "Let's push int b: test.push_back(b). " << endl;
	Sleep(200);
	cout << "Check value: " << endl;
	Sleep(200);
	cout << "test.front() = " << test.front() << endl;
	...
	cout << "test.size() = " << test.size() << endl << endl;
	Sleep(200);
	cout << "Let's pop front them. " << endl;
	Sleep(200);
	cout << "test.pop_front() = " << test.pop_front() << endl;
	Sleep(200);
	cout << "test.pop_front() = " << test.pop_front() << endl;
...
void UI::demonstration_mode_queue_string() {
	...
	cout << "string b = " << b << endl;
	test.push_back(b);
	cout << "Let's push string b: test.push_back(b). " << endl;
	Sleep(200);
	cout << "Check value: " << endl;
	Sleep(200);
	cout << "test.front() = " << test.front() << endl;
...
void UI::demonstration_mode_queue_vector() {
	...
	cout << "vector<int> b = " << b << endl;
	test.push_back(b);
	cout << "Let's push vector<int> b: test.push_back(b). " << endl;
	Sleep(200);
	cout << "Check value: " << endl;
	Sleep(200);
	cout << "test.front() = " << test.front() << endl;
...
void UI::demonstration_mode_queue_custom() {
	...
	Sleep(200);
	test.push_back(a);
	cout << "Let's push TimeManagment a: test.push_back(a). " << endl;
	Sleep(200);
	cout << "Check value: " << endl;
	Sleep(200);
	TimeManagment b = test.front();
	cout << "TimeManagment b = test.front(), b.get_date_with_time1 = " << b.get_date_with_time(1) << endl;
	b = test.back();
	cout << "b = test.back(), b.get_date_with_time(1) = " << b.get_date_with_time(1) << endl;
	cout << "test.empty() = " << test.empty() << endl;
	cout << "test.size() = " << test.size() << endl << endl;
	...
	Sleep(200);
	b = test.pop_front();
	cout << "b = test.pop_front(), b.get_date_with_time(1) = " << b.get_date_with_time(1) << endl;
	Sleep(200);
	cout << "Check empty of queue: test.empty() = " << test.empty() << endl << endl;
	Sleep(200);
...
void UI::demonstration_mode_stack_custom() {
	...
	cout << " TimeManagment b = test.peek(), b.get_date_with_time(1) = " << b.get_date_with_time(1) << endl;
	cout << "test.empty() = " << test.empty() << endl;
	cout << "test.size() = " << test.size() << endl << endl;
	Sleep(200);
	cout << "Let's pop. " << endl;
...
int UI::main_menu()
{
	...
	do {
		...
		cout << endl;
		key = (key + 11) % 11;
		if (key == 0) cout << "-> Show date_with_times" << endl;
		else  cout << "   Show date_with_times" << endl;
		if (key == 1) cout << "-> Insert date_with_time1" << endl;
		else  cout << "   Insert date_with_time1" << endl;
		if (key == 2) cout << "-> Insert date_with_time2" << endl;
		else  cout << "   Insert date_with_time2" << endl;
		if (key == 3) cout << "-> Alternative date_with_time display" << endl;
		else  cout << "   Alternative date_with_time display" << endl;
		if (key == 4) cout << "-> Change of GMT" << endl;
		else  cout << "   Change of GMT" << endl;
		if (key == 5) cout << "-> Add and substract the difference of date_with_time1 and date_with_time2 to the date_with_times" << endl;
		else  cout << "   Add and substract the difference of date_with_time1 and date_with_time2 to the date_with_times" << endl;
		if (key == 6) cout << "-> Show day of week for each date_with_time" << endl;
		else  cout << "   Show day of week for each date_with_time" << endl;
		if (key == 7) cout << "-> Show week number in month and year for each date_with_time" << endl;
		else  cout << "   Show week number in month and year for each date_with_time" << endl;
		if (key == 8) cout << "-> Convert date_with_times to Julian calendar" << endl;
		else  cout << "   Convert date_with_times to Julian calendar" << endl;
...
int UI::variant_of_output_difference() {
	...
	do {
		system("cls");
		cout << "############################################################" << endl;
		cout << "#     Choose variant of output difference between date_with_time     #" << endl;
		cout << "############################################################" << endl;
		cout << endl;
		key = (key + 4) % 4;
