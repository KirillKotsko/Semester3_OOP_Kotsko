...
void TestDateMinusDate() {
	...
	ASSERT_EQUAL(test.get_difference(), DifferenceBetweenDate({ 543, 18, 22, 26 }));
	test.set_date(Date({ 10, 8, 2020, 14, 55, 32 }), 2);
	ASSERT_EQUAL(test.get_difference(), DifferenceBetweenDate({ 4, 0, 0, 0 }));
	test.set_date(Date({ 2, 3, 2019, 20, 33, 6 }), 1);
	test.set_date(Date({ 9, 2, 2019, 20, 33, 6 }), 2);
	ASSERT_EQUAL(test.get_difference(), DifferenceBetweenDate({ 21, 0, 0, 0 }));
	test.set_date(Date({ 9, 2, 2019, 5, 12, 59 }), 1);
	ASSERT_EQUAL(test.get_difference(), DifferenceBetweenDate({ 0, 15, 20, 7 }));
	test.set_date(Date({ 9, 2, 2020, 20, 33, 7 }), 1);
	ASSERT_EQUAL(test.get_difference(), DifferenceBetweenDate({ 365, 0, 0, 1 }));
	test.set_date(Date({ 9, 2, 2021, 20, 33, 7 }), 2);
	ASSERT_EQUAL(test.get_difference(), DifferenceBetweenDate({ 366, 0, 0, 0 }));
	test.set_date(Date({ 19, 6, 1950, 19, 0, 0 }), 1);
	test.set_date(Date({ 05, 03, 2012, 21, 0, 0 }), 2);
	ASSERT_EQUAL(test.get_difference(), DifferenceBetweenDate({ 22540, 2, 0, 0 }));
